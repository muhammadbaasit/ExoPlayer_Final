...
class GetBackgroundNotification(private val context: Context, private var myService: AudioPlayerService?) : AsyncTask<Long, Void, Any>() {
    ...
    override fun doInBackground(vararg params: Long?): Any? {
        ...
        val notifyIntent = Intent(context, AudioPlay::class.java)
